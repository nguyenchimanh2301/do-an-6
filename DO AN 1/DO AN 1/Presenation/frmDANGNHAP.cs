...
namespace DO_AN_1.Presenation
{
    class frmDANGNHAP
    {
        DangnhapB DNB = new DangnhapB();
        GD gd = new GD(100, 45);
        frmTANGKT tang = new frmTANGKT();
        frmPHONGKT phong = new frmPHONGKT();
        frmSV sinhvien = new frmSV();
        ...
        public void menu()
        {
            ...
            gd.pain("F1", 9, 12); gd.pain("TẦNG KÍ TÚC", 60, 12);
            gd.pain("F2", 9, 15); gd.pain("PHÒNG  KÍ TÚC", 60, 15);
            gd.pain("F3", 9, 18); gd.pain("SINH VIEN", 60, 18);
            gd.pain("F3", 9, 21); gd.pain("HÓA ĐƠN", 60, 21);
            gd.pain("F4", 9, 24); gd.pain("TRỞ LẠI", 60, 24);
            den:
            ConsoleKeyInfo kt = Console.ReadKey();
            switch (kt.Key)
            {
                case ConsoleKey.F1: Console.Clear(); tang.menutangkt(); break;
                case ConsoleKey.F2:Console.Clear();phong.menuphong();break;
                case ConsoleKey.F3:Console.Clear();sinhvien.menuSV();break;
                default:
        ...
        //            gd.pain(s, 16, 17);
        //            gd.pain(s, 16, 29);
        //            Console.SetCursorPosition(55,19); tkhoan = Console.ReadLine();
        //            Console.SetCursorPosition(55,28); matkhau = nhapmatkau();
        //            if (DNB.kiemtratk(tkhoan, matkhau) == false)
        //            {
        //                Console.ForegroundColor = ConsoleColor.Red;
        //                gd.pain("Ban nhap sai tai khoan ! ", 28, 27);
        //                gd.pain("Nhan phim bat ki de nhap lai ", 28, 28);
        ...
        //            return s;
        //        }
        //        public bool kiemtratk(Dangnhap t)
        //        {
        //            bool oke = false;
        //            if (DNB.kiemtratk(t.Taikhoan, t.Matkhau))
        //            {
        //                oke = true;
        //            }
        //            return oke;
